...
class Grille2048(Frame):
    def __init__(self):
        ...
        self.master.title('Projet S2 32768 : Michel | El Hadad | Merveille | Doutrelon | Nique')
            ...
            for j in range(LEN_GRILLE):
                ...
                if valeur_cellule == 0:
                    ...
                    if valeur_cellule <= 8192:
                        ...
                        if valeur_cellule == 16384:
                            self.cellule_grille[i][j].configure(text='16K', bg=DICO_BG_CELLULE[valeur_cellule], fg=DICO_FG_CELLULE[valeur_cellule])
                        else:
                            self.cellule_grille[i][j].configure(text='32K', bg=DICO_BG_CELLULE[valeur_cellule], fg=DICO_FG_CELLULE[valeur_cellule])
